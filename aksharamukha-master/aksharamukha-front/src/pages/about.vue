<template>
    <q-page padding>
      <q-page-sticky position="top-right">
        ...
        <div class="q-mb-md">
          <transliterate text='viśvāmitramācāryamevamāha - katamāṃ me bho upādhyāya lipiṃ śikṣāpayasi? brāhmīkharoṣṭīpuṣkarasāriṃ aṅgalipiṃ vaṅgalipiṃ [...] cīnalipiṃ lūnalipiṃ hūṇalipiṃ [...] āsāṃ bho upādhyāya catuṣṣaṣṭīlipīnāṃ katamāṃ tvaṃ śiṣyāpayiṣyasi?' src="IAST" :tgt="options.script" :sourcePreserve="options.sourcePreserve" :postOptions="options.postOptions"> </transliterate>
        </div>
        <div class="q-mb-md">
                [He then] addressed the master Vishvamitra. Which script, O master, will you be teaching me? The Brahmi script, the Kharoshthi script, the Pushkarasari script, the Anga script, the Vanga script, [...] the Chinese script, the Luna script, the Hun script [...] Master, which of those 64 scripts will you teach me?
        </div>
