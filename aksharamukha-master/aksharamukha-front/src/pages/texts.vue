...
---
<div>
<h5>ܒܘܕܩܐ ܬܝܒ݂ܠܝܐ ܠܦܘܬ ܙܕܩܐ ܐܢܫܝܐ</h5>
      ܥܘܬܕܐ
...
`
  ...
  watch: {
    '$route' (to, from) {
      ...
      this.text = '. . .'
      if (this.name === 'udhr') {
        if (this.options.script === 'IAST') {
          this.$set(this.options, 'script', 'Latn')
        }
      } else {
        if (this.options.script === 'Latn') {
          this.$set(this.options, 'script', 'IAST')
        }
      }
